...
// add_action('wp_enqueue_scripts', 'all_business_developer_mode');
...
function all_business_add_global_icons() {
	...
	$icons = $file_gc(get_template_directory() . '/' . CMSMASTERS_ADMIN . '/inc/fonts/config.json');
	
	$icons_custom = $file_gc(get_template_directory() . '/' . CMSMASTERS_ADMIN . '/inc/fonts/config-custom.json');
