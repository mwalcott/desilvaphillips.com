...
if ($best == 'true') {
	...
	if ($best_bg_color != '') {
		$this->pricing_table_items_atts['style_pricing'] .= '#cmsmasters_pricing_item_' . $unique_id . '.pricing_best .cmsmasters_price_wrap { ' . 
...
'>' . "\n" . 
	'<div class="cmsmasters_pricing_item_inner">' . "\n" . 
		...
		'<span class="cmsmasters_price_price_period">' . 
